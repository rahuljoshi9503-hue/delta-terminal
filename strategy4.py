...
Delta Exchange India - Pure Python (No Pip / No Pandas Needed)
"""
...
def calculate_indicators(candles):
    ...
    # SMMA 9 (Pine Script rma / alpha = 1/9)
    alpha_smma = 1.0 / 9.0
    smma = closes[0]
    for c in closes[1:]:
...
# ==========================================
# 3. Delta Exchange API डेटा मिळवणे
# ==========================================
...
# ==========================================
# 4. मुख्य बॉट लूप (Indicator base Strategy)
# ==========================================
...
def run_strategy():
    ...
    print("\n" + "="*50)
    print(" 🚀 'Indicator base Strategy' बॉट सुरू झाला आहे...")
    print("="*50 + "\n")
        ...
        try:
            ...
            if candles and len(candles) >= 20:
                ...
                if current_position == 0 and not gamma_risk:
                    if bullish_tractor:
                        print("🟢 [ENTRY SIGNAL] Bullish Tractor: Sell PE (Order Trigger)")
                        current_position = 1
                    elif bearish_tractor:
                        print("🔴 [ENTRY SIGNAL] Bearish Tractor: Sell CE (Order Trigger)")
                        current_position = -1
            ...
            time.sleep(15)  # दर १५ सेकंदांनी डेटा चेक करेल
